...
const GoTop = () => {
  ...
  // Manejar el evento de scroll y actualizar el estado isVisible
  const handleScroll = () => {
    const scrollTop = window.scrollY;
    setIsVisible(scrollTop > 100); // Ajusta el valor según tus necesidades
  };

  // Agregar un event listener cuando se monta el componente
  useEffect(() => {
