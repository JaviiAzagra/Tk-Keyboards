...
const CoiledCable = ({ agregarAlCarrito }) => {
      ...
      try {
        ...
        const filteredData = response.data.filter(
          (item) =>
            ...
            item.accessoriesType === "Coiled Cable"
        );
  ...
  const productType = ["Coiled Cable"];
  ...
  return (
    <div className="products">
      <div className="products__backgroundkeyboardsfilters">
        <h2>Coiled Cable Pad</h2>
        <h3>All Coiled Cable collection.</h3>
      </div>
      {loading ? (
        <>
          <Loader />
