...
const Mouse = ({ agregarAlCarrito }) => {
    ...
    const fetchData = async () => {
      try {
        ...
        const filteredData = response.data.filter(
          (item) =>
            item.type === "accessories" && item.accessoriesType === "Mouse"
        );
  ...
  const productBrand = ["SteelSeries", "Logitech", "Razer", "Glorious"];
  const productType = ["Mouse"];
